...
public class ActivityStackManager {
     ...
     **/
    private ActivityManagerDelegate mDelegate;
    /**
     * 维护activity的栈结构
     **/
     ...
     */
    private ActivityStackManager(boolean isBridge) {
        this.isBridge = isBridge;
        mDelegate = ActivityManagerDelegate.getInstance();
    }
    ...
    public static ActivityStackManager getInstance() {
        if (sInstance == null) {
            synchronized (ActivityStackManager.class) {
                if (sInstance == null) {
                    sInstance = new ActivityStackManager(true);
                }
            }
        }
        return sInstance;
    ...
    public Activity getActivityByName(Class clazz) {
        if (isBridge) {
            return mDelegate.getActivityByName(clazz);
        }
        if (mActivityStack != null) {
